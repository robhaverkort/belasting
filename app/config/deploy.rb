...
set :repository,  "https://github.com/robhaverkort/belasting.git"
set :scm,         :git
...
task :production do
  ...
  role :db, "www.rhbv.nl"
  set :deploy_to, "/home/rhbv/domains/rhbv.nl/private_html/belasting"
  set :user, "rhbv"
  set :use_sudo, false
  set :deploy_via, :copy
end
...
task :staging do
  ...
  set :deploy_to, "/var/www/belasting"
  set :user, "pi"
end
